...
#include "line_tracking/msg/detail/point_array__rosidl_typesupport_fastrtps_c.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_line_tracking
...
using _PointArray__ros_msg_type = line_tracking__msg__PointArray;
...
static uint32_t _PointArray__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_line_tracking__msg__PointArray(
...
static size_t _PointArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_line_tracking__msg__PointArray(
