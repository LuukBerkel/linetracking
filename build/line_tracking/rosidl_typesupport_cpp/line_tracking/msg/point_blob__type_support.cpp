...
static const _PointBlob_type_support_symbol_names_t _PointBlob_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, line_tracking, msg, PointBlob)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, line_tracking, msg, PointBlob)),
  }
};
...
{
  return &::line_tracking::msg::rosidl_typesupport_cpp::PointBlob_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, line_tracking, msg, PointBlob)() {
  return get_message_type_support_handle<line_tracking::msg::PointBlob>();
}
