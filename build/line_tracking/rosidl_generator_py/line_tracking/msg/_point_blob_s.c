...
bool line_tracking__msg__point_blob__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("line_tracking.msg._point_blob.PointBlob", full_classname_dest, 39) == 0);
  }
  line_tracking__msg__PointBlob * ros_message = _ros_message;
  {  // arrays
    ...
    line_tracking__msg__PointArray * dest = ros_message->arrays.data;
...
{
  /* NOTE(esteve): Call constructor of PointBlob */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("line_tracking.msg._point_blob");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PointBlob");
