...
{
  new (message_memory) line_tracking::msg::PointArray(_init);
}

void PointArray_fini_function(void * message_memory)
{
  auto typed_message = static_cast<line_tracking::msg::PointArray *>(message_memory);
...
void fetch_function__PointArray__points(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const geometry_msgs::msg::Point *>(
    get_const_function__PointArray__points(untyped_member, index));
  auto & value = *reinterpret_cast<geometry_msgs::msg::Point *>(untyped_value);
  value = item;
}

void assign_function__PointArray__points(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<geometry_msgs::msg::Point *>(
    get_function__PointArray__points(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember PointArray_message_member_array[1] = {
  {
    ...
    offsetof(line_tracking::msg::PointArray, points),  // bytes offset in struct
    ...
    fetch_function__PointArray__points,  // fetch(index, &value) function pointer
    assign_function__PointArray__points,  // assign(index, value) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers PointArray_message_members = {
  ...
  1,  // number of fields
  sizeof(line_tracking::msg::PointArray),
...
{
  return &::line_tracking::msg::rosidl_typesupport_introspection_cpp::PointArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, line_tracking, msg, PointArray)() {
  return &::line_tracking::msg::rosidl_typesupport_introspection_cpp::PointArray_message_type_support_handle;
}
